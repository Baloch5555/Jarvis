...
const { loadEnv } = require("Mr_SAJÓØ");
const fs = require('fs');
...
module.exports = {
  ...
  AUDIO_DATA: process.env.AUDIO_DATA || 'MR SAJÓØ;https://files.catbox.moe/hfdqou.jpg',
  ...
  CONTEXTINFO: process.env.CONTEXTINFO || `{"title": "Mr_Sajóø", "body": "MrSAJÓØ 🍉", "thumbnailUrl": "https://files.catbox.moe/hfdqou.jpg", "renderLargerThumbnail": false, "mediaType": 1, "mediaUrl": "", "sourceUrl": "https://github.com/Loki-Xer/Jarvis", "showAdAttribution": true}`,
  ...
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || 'MR SAJÓØ',
  ...
  MEDIA_DATA: process.env.MEDIA_DATA|| 'Mr SAJÓØ;https://files.catbox.moe/hfdqou.jpg',
  ...
  STATUS_REPLY_MSG: process.env.STATUS_REPLY_MSG || "*YOUR STATUS SEEN BY MY OWNER 😉 MR SAJÓØ 🥰✨*",
  ...
  BOT_INFO: process.env.BOT_INFO || 'Mr SAJÓØ;https://files.catbox.moe/hfdqou.jpg',
